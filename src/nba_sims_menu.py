...
#
#     def get_csv_files(self):
#         """Get list of CSV files from sibling directory."""
#         parent_dir = os.path.dirname(self.script_dir)
#         csv_dir = os.path.join(parent_dir, "dk_contests")  # Change "csv_files" to your actual directory name
#
#         if os.path.exists(csv_dir):
#             # Clear the existing dictionary
#             self.full_filenames.clear()
#
#             # Get all CSV files and create display names
#             files = [f for f in os.listdir(csv_dir) if f.endswith('.csv')]
#             for full_name in files:
...
#             #return list(self.full_filenames.keys())
...
#         display_name = self.csv_combo.currentText()
#         if display_name:
#             # Get the full filename from our dictionary
#             full_filename = self.full_filenames.get(display_name)
#             if full_filename:
#                 parent_dir = os.path.dirname(self.script_dir)
#                 csv_dir = os.path.join(parent_dir, "dk_contests")
#                 return os.path.join(csv_dir, full_filename)
#         return None
#
#     def init_ui(self):
#         # Central widget
